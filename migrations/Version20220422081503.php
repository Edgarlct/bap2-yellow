 ...
 */
final class Version20220422081503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_content ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE blog_content ADD CONSTRAINT FK_12338D2AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_12338D2AA76ED395 ON blog_content (user_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE blog_content DROP FOREIGN KEY FK_12338D2AA76ED395');
        $this->addSql('DROP INDEX IDX_12338D2AA76ED395 ON blog_content');
        $this->addSql('ALTER TABLE blog_content DROP user_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE picture picture VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
