...
class Carousel {
    ...
    setControls() {
        ...
        // !!galleryControlsContainer.childNodes[0] ? galleryControlsContainer.childNodes[0].innerHTML = this.carouselControls[] : null;
        // !!galleryControlsContainer.childNodes[1] ? galleryControlsContainer.childNodes[1].innerHTML = this.carouselControls[] : null;
    }
...
let registerBtn = document.querySelector('#menu-register-btn');
...
toggleMenuBtn.addEventListener('click', (e) => {
        if(! menuOpen){
            ...
            registerBtn.classList.add("nav-element-translate-in")
            ...
            registerBtn.classList.remove("nav-element-translate-in")
